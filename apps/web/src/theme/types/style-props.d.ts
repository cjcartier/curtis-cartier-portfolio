...
type CssVars = "var(--background-grain)" | "var(--background-grain-dark)"
type CssVarValue = ConditionalValue<Token | CssVars | AnyString | (number & {})>

type CssVarName = "background-grain" | "background-grain-dark" | AnyString
...
scrollSnapMarginRight?: ConditionalValue<UtilityValues["scrollSnapMarginRight"] | CssVars | AnyString>
 ...
 absoluteCover?: ConditionalValue<UtilityValues["absoluteCover"] | CssVars | AnyString>
